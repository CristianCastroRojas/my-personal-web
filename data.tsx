...
import { FaFacebook,FaLinkedin, FaWhatsapp, FaTelegram, FaPaypal } from 'react-icons/fa';
...
export const socialNetworks = [
    ...
    {
        id: 4,
        logo: <FaTelegram size={30} strokeWidth={1} />,
        src: "#!",
    },
    {
        id: 5,
        logo: <FaPaypal size={30} strokeWidth={1} />,
        src: "#!",
    },
];
