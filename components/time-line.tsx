            ...
            {dataAboutPage.map((data) => (
                <div key={data.id} 
                    ...
                    <div className="flex flex-col sm:flex-row items-start mb-1 
                        ...
                        sm:after:left-0 after:w-2 after:h-2 after:bg-yellow-300 
                        ...
                        after:translate-y-1.5">
                            <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center
                                ...
                                text-gray-950 bg-secondary rounded-full
                            ">{data.date}</time>
                            <p className="text-xl font-bold text-gray-200">{data.subtitle}</p>
                    </div>
                    <p className="text-slate-250 max-w-md">{data.description}</p>
                </div>
